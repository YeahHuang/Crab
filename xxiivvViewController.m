...
-(void)questionStart
{
    ...
    _questionLabel.text = @"";
    NSString *gif = [NSString stringWithFormat:@"%@",[activeLesson question:lessonId]];
    ...
    choice1Frame = CGRectMake(0, screenHeight-(screenMargin*6)-2, screenWidth, screenMargin*5/3);
    GifView *dataView = [[GifView alloc] initWithFrame: CGRectMake(screenWidth*0.25, screenHeight-(screenMargin*12)-15, screenWidth*0.5, screenMargin*6) data:localData];
    [self.view addSubview:dataView];
    
    if( currentMode == NAME ){ [_languageToggleButton setTitle:@"称谓" forState:UIControlStateNormal]; }
    else if( currentMode == FESTIVAL ){ [_languageToggleButton setTitle:@"祝福" forState:UIControlStateNormal]; }
    else if( currentMode == HAHA ) { [_languageToggleButton setTitle:@"表情包" forState:UIControlStateNormal]; }
...
-(void)templateStart
{
    ...
    choice2Frame = CGRectMake(0, screenHeight-(screenMargin*13/3)-1, screenWidth, screenMargin*5/3);
    ...
    choice3Frame = CGRectMake(0, screenHeight-(screenMargin*8/3), screenWidth, screenMargin*5/3);
